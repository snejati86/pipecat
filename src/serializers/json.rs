...
fn serialize_frame_to_json(frame: &FrameEnum) -> Option<String> {
    match frame {
...
mod tests {
    ...
    fn roundtrip(serializer: &JsonFrameSerializer, frame: &FrameEnum) -> FrameEnum {
